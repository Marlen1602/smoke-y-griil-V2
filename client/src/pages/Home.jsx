      ...
      <header className="flex justify-between items-center p-4 shadow-md bg-black">
        ...
        <div className="flex items-center space-x-8 text-white">
          ...
          <div className="text-white-700 text-sm flex items-center">
            ...
            <span className="ml-2 cursor-pointer text-white"  onClick={handleLoginClick}>Ingreso</span>
          </div>
      ...
      <main className="flex flex-col md:flex-row items-center justify-center p-8 md:p-16 space-y-8 md:space-y-0">
        <div className="md:w-1/2">
          <img
            src={imagen}
            alt="imagen"
            className="w-4/4 mx-auto md:w-full"
          />
        </div>
        <div className="md:w-1/2 text-center md:text-left-2">
          ...
          <button className="bg-orange-700 text-white py-3 px-6 rounded-full font-bold hover:bg-orange-500 transition" onClick={handleLoginClick}>¡Pide ahora!</button>
        </div>
      </main>
    </div>
  );
