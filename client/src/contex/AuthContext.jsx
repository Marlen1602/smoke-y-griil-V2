...
const API = 'http://modulo-usuarios.vercel.app/api'; 
...
export const AuthProvider = ({ children }) => {
  ...
  const verifyCode = async (formData) => {
    try {
      ...
      const res = await axios.post(
        "http://modulo-usuarios.vercel.app/api/verify-email",
        formData
      );
      setErrors([]);
      return res.data;
  ...
  const updatePassword = async (formData) => {
    try {
      ...
      const res = await axios.put(
        "http://modulo-usuarios.vercel.app/api/update-password",
        formData
      );
      setErrors([]);
      return res.data;
  ...
  const verifyCodeForPassword = async (formData) => {
    ...
    try {
      // TODO : cambiar a variables de entorno
      const res = await axios.post(
        "http://modulo-usuarios.vercel.app/api/verify-code-password",
        {
          email: email,
          code: formData.code,
        }
  ...
  const sendEmailResetPassword = async (formData) => {
    try {
      // TODO : cambiar a variables de entorno
      const res = await axios.post(
        "http://modulo-usuarios.vercel.app/api/email-reset-password",
        {
          email: formData,
        }
      );
